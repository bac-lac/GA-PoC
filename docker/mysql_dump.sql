...
--
-- Host: localhost    Database: GADATA
-- ------------------------------------------------------
...
CREATE TABLE `dpa_active_job` (
  ...
  PRIMARY KEY (`job_id`),
  KEY `idx_ajob_proj` (`proj_id`),
  KEY `idx_ajob_primary` (`domain_id`,`agent_id`,`agent_group_id`,`system_name` DESC,`job_queue_id`)
...
INSERT INTO `dpa_active_system` VALUES ('Default','default',' ',0,'2025-04-07 18:33:55','X','1');
...
CREATE TABLE `dpa_agent` (
  ...
  `connection_status` char(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `dpa_content_scan_log` (
  ...
  KEY `idx_icaplog_indexed` (`indexed`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `dpa_filecatalyst_audit_log`
--

DROP TABLE IF EXISTS `dpa_filecatalyst_audit_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dpa_filecatalyst_audit_log` (
  `event_id` bigint NOT NULL,
  ...
  `checksum` varchar(91) DEFAULT NULL,
  PRIMARY KEY (`event_id`),
  KEY `idx_dpa_filecatalyst_audit_log` (`start_time` DESC),
  KEY `idx_dpa_filecatalyst_audit_log_usr` (`user_id`),
  KEY `idx_dpa_filecatalyst_audit_log_session` (`session_id`),
  KEY `idx_filecatalyst_indexed` (`indexed`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dpa_filecatalyst_audit_log`
--

LOCK TABLES `dpa_filecatalyst_audit_log` WRITE;
/*!40000 ALTER TABLE `dpa_filecatalyst_audit_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `dpa_filecatalyst_audit_log` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `dpa_gd_audit_log` (
  ...
  KEY `idx_gdlog_indexed` (`indexed_godrive`,`indexed_global`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dpa_gofast_audit_log` (
  ...
  KEY `idx_gofast_indexed` (`indexed`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dpa_job` (
  ...
  `checksum` varchar(91) DEFAULT NULL,
  PRIMARY KEY (`job_id`),
  KEY `idx_job_primary` (`start_time` DESC,`domain_id`,`status` DESC,`run_user` DESC,`system_name` DESC),
  KEY `idx_job_agent` (`start_time` DESC,`domain_id`,`status` DESC,`agent_id`,`submit_src_alt_id`,`submit_src`),
  KEY `idx_job_agent_grp` (`start_time` DESC,`domain_id`,`agent_group_id`,`status` DESC),
  KEY `idx_job_proj` (`start_time` DESC,`proj_id`),
  KEY `idx_job_stats` (`start_time` DESC,`domain_id`,`agent_id`,`agent_group_id`,`status` DESC,`run_user` DESC),
  KEY `idx_job_indexed` (`status` DESC,`indexed`),
  KEY `idx_job_sched` (`start_time` DESC,`submit_src`,`submit_src_id`),
...
CREATE TABLE `dpa_job_file_log` (
  ...
  KEY `idx_jobfile_indexed` (`indexed`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `dpa_login_method` VALUES (100,'Anonymous','anonymous','This method will authenticate the Anonymous web user.','com.linoma.dpa.security.AnonymousLoginMethod','1','system','2024-04-22 14:01:10','system','2024-04-22 14:01:10','0',NULL,NULL,'B'),(101,'GoAnywhere','goanywhere','This method will authenticate against GoAnywhere internal data store.','com.linoma.dpa.security.InternalLoginMethod','0','system','2024-04-22 14:01:10','system','2024-04-22 14:01:10','1',NULL,NULL,'B');
...
CREATE TABLE `dpa_queued_job` (
  ...
  PRIMARY KEY (`job_id`),
  KEY `idx_qjob_primary` (`domain_id`,`agent_id`,`agent_group_id`,`job_type`,`job_queue_id`,`system_name` DESC)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `dpa_role` VALUES (101,'Product Administrator','Admin users with this role can perform product administration tasks such as setting the global preferences, applying product updates and fixes, installing/updating product license and more','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\"Statement\":[{\"Sid\":\"Allowed Permissions Statement\",\"Effect\":\"Allow\",\"Action\":[\"softwareLibrary:*\",\"webClientBrands:*\",\"customTasks:*\",\"encryptedFolders:*\",\"keyVaults:manageSystem\",\"logSettings:*\",\"reports:generate\",\"license:*\",\"gatewayManager:*\",\"clusterManager:*\",\"addons:*\",\"checkForUpdates:*\",\"adminServer:*\",\"jdbcWizard:*\",\"goDriveSettings:*\",\"activeTransfers:*\",\"masterEncryptionKeys:*\",\"globalSettings:*\",\"queues:*\",\"logExemptions:*\",\"reports:generateProductUsage\",\"systemAlerts:*\",\"activeSessions:*\",\"systemLogs:*\",\"databaseConfiguration:*\",\"adminLogs:view\",\"services:*\",\"diagnostics:*\",\"messageChannels:*\",\"pesitFileTemplates:*\",\"icapSettings:*\"],\"Object\":[\"gon:mft::queues::*\",\"gon:mft::services::*\",\"gon:mft::webClientBrands::*\",\"gon:mft::gatewayManager::*\",\"gon:mft::goDriveSettings::*\",\"gon:mft::reports::*\",\"gon:mft::systemLogs::*\",\"gon:mft::logSettings::*\",\"gon:mft::logExemptions::*\",\"gon:mft::encryptedFolders::*\",\"gon:mft::globalSettings::*\",\"gon:mft::adminServer::*\",\"gon:mft::databaseConfiguration::*\",\"gon:mft::clusterManager::*\",\"gon:mft::customTasks::*\",\"gon:mft::addons::*\",\"gon:mft::systemAlerts::*\",\"gon:mft::activeSessions::*\",\"gon:mft::activeTransfers::*\",\"gon:mft::jdbcWizard::*\",\"gon:mft::checkForUpdates::*\",\"gon:mft::license::*\",\"gon:mft::diagnostics::*\",\"gon:mft::softwareLibrary::*\",\"gon:mft::adminLogs::*\",\"gon:mft::masterEncryptionKeys::*\",\"gon:mft::keyVaults::*\",\"gon:mft::messageChannels::*\",\"gon:mft::pesitFileTemplates::*\",\"gon:mft::icapSettings::*\"],\"Domain\":[\"*\"]}]}',0,0),(102,'Security Officer','Admin users with this role are allowed to create users, groups and assigning them roles and object authorities','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\"Statement\":[{\"Sid\":\"Allowed Permissions Statement\",\"Effect\":\"Allow\",\"Action\":[\"loginMethods:*\",\"users:*\",\"reports:generateSecurityAudit\",\"reports:generate\",\"userTemplates:*\",\"userGroups:*\",\"webUserSecuritySettings:*\",\"adminSecuritySettings:*\",\"agentTemplates:*\",\"agentGroups:*\",\"ipFilters:*\",\"autoIPBlacklist:*\",\"masterEncryptionKeys:*\",\"agents:*\",\"userRoles:*\",\"adminLogs:view\",\"loginSettings:*\",\"domains:*\",\"webUserSelfRegistrationSettings:*\",\"globalSecuritySettings:*\",\"projectCategories:managePermissions\",\"resources:managePermissions\",\"resources:list\",\"projectCategories:list\",\"adminUserApiKeys:*\",\"threatBrainSettings:edit\"],\"Object\":[\"gon:mft::resources:*\",\"gon:mft::projectCategories::*\",\"gon:mft::projects:*:*\",\"gon:mft::agentGroups::*\",\"gon:mft::agentTemplates::*\",\"gon:mft::agents::*\",\"gon:mft::users::*\",\"gon:mft::userGroups::*\",\"gon:mft::userTemplates::*\",\"gon:mft::userRoles::*\",\"gon:mft::adminSecuritySettings::*\",\"gon:mft::webUserSecuritySettings::*\",\"gon:mft::webUserSelfRegistrationSettings::*\",\"gon:mft::domains::*\",\"gon:mft::loginSettings::*\",\"gon:mft::loginMethods::*\",\"gon:mft::reports::*\",\"gon:mft::globalSecuritySettings::*\",\"gon:mft::ipFilters::*\",\"gon:mft::autoIPBlacklist::*\",\"gon:mft::masterEncryptionKeys::*\",\"gon:mft::adminLogs::*\",\"gon:mft::adminUserApiKeys::*\",\"gon:mft::threatBrainSettings::edit\"],\"Domain\":[\"*\"]}]}',0,0),(103,'Web User Manager','Admin users with this role can manage Web Users and Web User Groups','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\"Statement\":[{\"Sid\":\"Allowed Permissions Statement\",\"Effect\":\"Allow\",\"Action\":[\"reports:generate\",\"ftpLogs:*\",\"ftpsLogs:*\",\"webuserGroups:*\",\"adminLogs:view\",\"webusers:*\",\"httpsLogs:*\",\"as2Logs:*\",\"as4Logs:*\",\"godriveLogs:*\",\"gofastLogs:*\",\"pesitLogs:*\",\"webuserTemplates:*\",\"sftpLogs:*\",\"addressBooks:*\",\"filecatalystLogs:view\"],\"Object\":[\"gon:mft::webusers::*\",\"gon:mft::webuserGroups::*\",\"gon:mft::webuserTemplates::*\",\"gon:mft::reports::*\",\"gon:mft::as2Logs::*\",\"gon:mft::as4Logs::*\",\"gon:mft::ftpLogs::*\",\"gon:mft::ftpsLogs::*\",\"gon:mft::gofastLogs::*\",\"gon:mft::godriveLogs::*\",\"gon:mft::sftpLogs::*\",\"gon:mft::httpsLogs::*\",\"gon:mft::adminLogs::*\",\"gon:mft::addressBooks::*\",\"gon:mft::pesitLogs::*\",\"gon:mft::filecatalystLogs::*\"],\"Domain\":[\"*\"]}]}',0,0),(104,'Key Manager','Admin users with this role can manage various types of encryption keys such as SSH and x509','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\r\n  \"Statement\":\r\n    {\r\n      \"Sid\": \"Allowed Permissions Statement\",\r\n      \"Effect\": \"Allow\",\r\n      \"Action\": [\r\n        \"keyVaults:manageKeyVaults\",\r\n        \"keyVaults:create\",\r\n        \"keyVaults:edit\",\r\n        \"keyVaults:delete\",\r\n        \"keyVaults:view\",\r\n        \"reports:generate\",\r\n        \"fileBasedKeys:*\"\r\n      ],\r\n      \"Object\": [\r\n        \"gon:mft::reports::*\",\r\n        \"gon:mft::fileBasedKeys::*\",\r\n        \"gon:mft::keyVaults::*\"\r\n      ],\r\n      \"Domain\": [\r\n        \"*\"\r\n      ]\r\n    }\r\n}\r\n',0,0),(105,'File Manager','Admin users with this role can manage (e.g. download, copy, delete, upload) files on the GoAnywhere server','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\r\n  \"Statement\": [\r\n    {\r\n      \"Sid\": \"Allowed Permissions Statement\",\r\n      \"Effect\": \"Allow\",\r\n      \"Action\": [\r\n        \"reports:generate\",\r\n        \"fileManager:*\"\r\n      ],\r\n      \"Object\": [\r\n        \"gon:mft::reports::*\",\r\n        \"gon:mft::fileManager::*\"\r\n      ],\r\n      \"Domain\": [\r\n        \"*\"\r\n      ]\r\n    }\r\n  ]\r\n}\r\n',0,0),(106,'Trigger Manager','Admin users with this role can manage Triggers and Actions that are executed during events','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\r\n  \"Statement\": [\r\n    {\r\n      \"Sid\": \"Allowed Permissions Statement\",\r\n      \"Effect\": \"Allow\",\r\n      \"Action\": [\r\n        \"triggerLogs:*\",\r\n        \"reports:generate\",\r\n        \"adminLogs:view\",\r\n        \"triggers:*\"\r\n      ],\r\n      \"Object\": [\r\n        \"gon:mft::triggers::*\",\r\n        \"gon:mft::triggerLogs::*\",\r\n        \"gon:mft::reports::*\",\r\n        \"gon:mft::adminLogs::*\"\r\n      ],\r\n      \"Domain\": [\r\n        \"*\"\r\n      ]\r\n    }\r\n  ]\r\n}',0,0),(107,'Log Viewer','Admin users with this role can access the audit logs','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\"Statement\":[{\"Sid\":\"Allowed Permissions Statement\",\"Effect\":\"Allow\",\"Action\":[\"triggerLogs:*\",\"ftpLogs:*\",\"ftpsLogs:*\",\"gofastLogs:*\",\"jobs:view\",\"jobs:manageAllJobs\",\"sftpLogs:*\",\"reports:generate\",\"adminLogs:view\",\"adminLogs:all\",\"httpsLogs:*\",\"as2Logs:*\",\"as4Logs:*\",\"godriveLogs:*\",\"pesitLogs:*\",\"antivirusLogs:*\",\"serviceLevelAgreementLogs:*\",\"filecatalystLogs:view\"],\"Object\":[\"gon:mft::jobs::*\",\"gon:mft::reports::*\",\"gon:mft::as2Logs::*\",\"gon:mft::as4Logs::*\",\"gon:mft::httpsLogs::*\",\"gon:mft::ftpLogs::*\",\"gon:mft::ftpsLogs::*\",\"gon:mft::godriveLogs::*\",\"gon:mft::sftpLogs::*\",\"gon:mft::triggerLogs::*\",\"gon:mft::serviceLevelAgreementLogs::*\",\"gon:mft::gofastLogs::*\",\"gon:mft::adminLogs::*\",\"gon:mft::pesitLogs::*\",\"gon:mft::antivirusLogs::*\",\"gon:mft::filecatalystLogs::*\"],\"Domain\":[\"*\"]}]}',0,0),(108,'Secure Mail Manager','Admin users with this role can manage packages and Secure Mail settings','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\r\n  \"Statement\": [\r\n    {\r\n      \"Sid\": \"Allowed Permissions Statement\",\r\n      \"Effect\": \"Allow\",\r\n      \"Action\": [\r\n        \"secureMail:*\",\r\n        \"reports:generate\",\r\n        \"adminLogs:view\",\r\n        \"securemailSettings:*\"\r\n      ],\r\n      \"Object\": [\r\n        \"gon:mft::secureMail::*\",\r\n        \"gon:mft::securemailSettings::*\",\r\n        \"gon:mft::reports::*\",\r\n        \"gon:mft::adminLogs::*\"\r\n      ],\r\n      \"Domain\": [\r\n        \"*\"\r\n      ]\r\n    }\r\n  ]\r\n}',0,0),(109,'Resource Manager','Admin users with this role can manage resources such as FTP, SFTP, Databases, and Network Shares','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\r\n  \"Statement\": [\r\n    {\r\n      \"Sid\": \"Allowed Permissions Statement\",\r\n      \"Effect\": \"Allow\",\r\n      \"Action\": [\r\n        \"resources:list\",\r\n        \"resources:create\",\r\n        \"resources:manage\",\r\n        \"reports:generate\",\r\n        \"encryptionTool:*\",\r\n        \"jdbcWizard:*\",\r\n        \"sqlWizard:*\"\r\n      ],\r\n      \"Object\": [\r\n        \"gon:mft::resources:*\",\r\n        \"gon:mft::reports::*\",\r\n        \"gon:mft::encryptionTool::*\",\r\n        \"gon:mft::sqlWizard::*\",\r\n        \"gon:mft::jdbcWizard::*\"\r\n      ],\r\n      \"Domain\": [\r\n        \"*\"\r\n      ]\r\n    }\r\n  ]\r\n}',0,0),(110,'Web User Device Manager','Admin users with this role can manage Web User devices','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\r\n  \"Statement\": [\r\n    {\r\n      \"Sid\": \"Allowed Permissions Statement\",\r\n      \"Effect\": \"Allow\",\r\n      \"Action\": [\r\n        \"reports:generate\",\r\n        \"adminLogs:view\",\r\n        \"webUserDevices:*\"\r\n      ],\r\n      \"Object\": [\r\n        \"gon:mft::webUserDevices::*\",\r\n        \"gon:mft::reports::*\",\r\n        \"gon:mft::adminLogs::*\"\r\n      ],\r\n      \"Domain\": [\r\n        \"*\"\r\n      ]\r\n    }\r\n  ]\r\n}',0,0),(111,'Project Designer','Admin users in this role can create, edit and delete projects','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\r\n  \"Statement\": [\r\n    {\r\n      \"Sid\": \"Allowed Permissions Statement\",\r\n      \"Effect\": \"Allow\",\r\n      \"Action\": [\r\n        \"projectCategories:list\",\r\n        \"projectCategories:manage\",\r\n        \"reports:generate\",\r\n        \"jdbcWizard:*\",\r\n        \"sqlWizard:*\",\r\n        \"encryptionTool:use\"\r\n      ],\r\n      \"Object\": [\r\n        \"gon:mft::projectCategories::*\",\r\n        \"gon:mft::projects:*:*\",\r\n        \"gon:mft::reports::*\",\r\n        \"gon:mft::encryptionTool::*\",\r\n        \"gon:mft::sqlWizard::*\",\r\n        \"gon:mft::jdbcWizard::*\"\r\n      ],\r\n      \"Domain\": [\r\n        \"*\"\r\n      ]\r\n    }\r\n  ]\r\n}',0,0),(112,'Job Manager','Admin users in this role can monitor all active jobs, cancel jobs, pause/resume jobs and view/delete completed jobs','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\r\n  \"Statement\": [\r\n    {\r\n      \"Sid\": \"Allowed Permissions Statement\",\r\n      \"Effect\": \"Allow\",\r\n      \"Action\": [\r\n        \"activeTransfers:*\",\r\n        \"queues:edit\",\r\n        \"jobs:view\",\r\n        \"monitors:*\",\r\n        \"jobs:export\",\r\n        \"jobs:manageAllJobs\",\r\n        \"queues:manage\",\r\n        \"reports:generate\",\r\n        \"schedules:*\",\r\n        \"adminLogs:view\",\r\n        \"queues:view\",\r\n        \"jobs:jobResolution\",\r\n        \"holidayCalendars:*\",\r\n        \"jobs:manage\"\r\n      ],\r\n      \"Object\": [\r\n        \"gon:mft::schedules::*\",\r\n        \"gon:mft::queues::*\",\r\n        \"gon:mft::jobs::*\",\r\n        \"gon:mft::reports::*\",\r\n        \"gon:mft::activeTransfers::*\",\r\n        \"gon:mft::adminLogs::*\",\r\n        \"gon:mft::monitors::*\",\r\n        \"gon:mft::holidayCalendars::*\"\r\n      ],\r\n      \"Domain\": [\r\n        \"*\"\r\n      ]\r\n    }\r\n  ]\r\n}',0,0),(113,'Project Executor','Admin users in this role can execute projects and view jobs they submitted','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\r\n  \"Statement\": [\r\n    {\r\n      \"Sid\": \"Allowed Permissions Statement\",\r\n      \"Effect\": \"Allow\",\r\n      \"Action\": [\r\n        \"jobs:view\",\r\n        \"projectCategories:executeProjects\",\r\n        \"projectCategories:list\",\r\n        \"jobs:export\",\r\n        \"reports:generate\",\r\n        \"jobs:jobResolution\",\r\n        \"jobs:manage\"\r\n      ],\r\n      \"Object\": [\r\n        \"gon:mft::projectCategories::*\",\r\n        \"gon:mft::projects:*:*\",\r\n        \"gon:mft::jobs::*\",\r\n        \"gon:mft::reports::*\"\r\n      ],\r\n      \"Domain\": [\r\n        \"*\"\r\n      ]\r\n    }\r\n  ]\r\n}',0,0),(114,'Dashboard Manager','Admin users in this role can manage shared dashboards','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\r\n  \"Statement\": [\r\n    {\r\n      \"Sid\": \"Allowed Permissions Statement\",\r\n      \"Effect\": \"Allow\",\r\n      \"Action\": [\r\n        \"reports:generate\",\r\n        \"dashboards:*\"\r\n      ],\r\n      \"Object\": [\r\n        \"gon:mft::dashboards::*\",\r\n        \"gon:mft::reports::*\"\r\n      ],\r\n      \"Domain\": [\r\n        \"*\"\r\n      ]\r\n    }\r\n  ]\r\n}',0,0),(115,'Secure Forms Manager','Admin users in this role can manage Secure Forms','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\r\n  \"Statement\": [\r\n    {\r\n      \"Sid\": \"Allowed Permissions Statement\",\r\n      \"Effect\": \"Allow\",\r\n      \"Action\": [\r\n        \"reports:generate\",\r\n        \"secureForms:*\",\r\n        \"adminLogs:view\",\r\n        \"secureFormSettings:*\"\r\n      ],\r\n      \"Object\": [\r\n        \"gon:mft::secureForms::*\",\r\n        \"gon:mft::secureFormSettings::*\",\r\n        \"gon:mft::reports::*\",\r\n        \"gon:mft::adminLogs::*\"\r\n      ],\r\n      \"Domain\": [\r\n        \"*\"\r\n      ]\r\n    }\r\n  ]\r\n}',0,0),(116,'Agent Manager','Admin users in this role can manage Agents','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\r\n  \"Statement\": [\r\n    {\r\n      \"Sid\": \"Allowed Permissions Statement\",\r\n      \"Effect\": \"Allow\",\r\n      \"Action\": [\r\n        \"reports:generate\",\r\n        \"agentTemplates:create\",\r\n        \"agentTemplates:edit\",\r\n        \"agentTemplates:view\",\r\n        \"agentTemplates:delete\",\r\n        \"agentGroups:create\",\r\n        \"agentGroups:manage\",\r\n        \"agentGroups:delete\",\r\n        \"agents:create\",\r\n        \"agents:manage\",\r\n        \"agents:delete\"\r\n      ],\r\n      \"Object\": [\r\n        \"gon:mft::agents::*\",\r\n        \"gon:mft::agentGroups::*\",\r\n        \"gon:mft::agentTemplates::*\",\r\n        \"gon:mft::reports::*\"\r\n      ],\r\n      \"Domain\": [\r\n        \"*\"\r\n      ]\r\n    }\r\n  ]\r\n}',0,0),(117,'SLA Manager','Admin users in this role can manage Service Level Agreements','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{  \r\n   \"Statement\":[  \r\n      {  \r\n         \"Sid\":\"Allowed Permissions Statement\",\r\n         \"Effect\":\"Allow\",\r\n         \"Action\":[  \r\n            \"reports:generate\",\r\n            \"serviceLevelAgreements:*\",\r\n            \"serviceLevelAgreementLogs:*\"\r\n         ],\r\n         \"Object\":[  \r\n            \"gon:mft::reports::*\",\r\n            \"gon:mft::serviceLevelAgreements::*\",\r\n            \"gon:mft::serviceLevelAgreementLogs::*\"\r\n         ],\r\n         \"Domain\":[  \r\n            \"*\"\r\n         ]\r\n      }\r\n   ]\r\n}',0,0),(118,'3-101-101g',NULL,'system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\"Statement\":[{\"Effect\":\"Allow\",\"Action\":[\"projects:create\",\"projects:edit\",\"projects:move\",\"projects:delete\",\"projects:execute\",\"projects:export\",\"projects:promote\",\"projects:view\",\"projectCategories:create\",\"projectCategories:edit\",\"projectCategories:delete\",\"projectCategories:export\",\"projectCategories:permissions\"],\"Object\":[\"gon:mft::projectCategories::101\",\"gon:mft::projects:101:*\"],\"Domain\":[\"1\"]}]}\r\n',3,101),(119,'Auditor','Admin users in this role have View Only Access','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\"Statement\":[{\"Sid\":\"Allowed Permissions Statement\",\"Effect\":\"Allow\",\"Action\":[\"activeSessions:view\",\"schedules:view\",\"holidayCalendars:view\",\"customTasks:view\",\"godriveLogs:view\",\"services:view\",\"addons:view\",\"ftpsLogs:view\",\"webuserTemplates:view\",\"users:view\",\"webUserDevices:view\",\"databaseConfiguration:view\",\"jobs:view\",\"jobs:manageAllJobs\",\"adminServer:view\",\"ftpLogs:view\",\"userGroups:view\",\"webClientBrands:view\",\"webuserGroups:view\",\"triggerLogs:view\",\"gofastLogs:view\",\"secureMail:view\",\"httpsLogs:view\",\"loginMethods:view\",\"autoIPBlacklist:view\",\"keyVaults:view\",\"agentTemplates:view\",\"logExemptions:view\",\"domains:view\",\"sftpLogs:view\",\"activeTransfers:view\",\"userTemplates:view\",\"addressBooks:view\",\"monitors:view\",\"triggers:view\",\"masterEncryptionKeys:view\",\"ipFilters:view\",\"serviceLevelAgreementLogs:view\",\"license:view\",\"systemLogs:view\",\"as2Logs:view\",\"as4Logs:view\",\"pesitLogs:view\",\"antivirusLogs:view\",\"secureForms:view\",\"serviceLevelAgreements:view\",\"adminLogs:view\",\"adminLogs:all\",\"encryptedFolders:view\",\"queues:view\",\"gatewayManager:view\",\"webusers:view\",\"userRoles:view\",\"reports:generate\",\"projects:viewOnly\",\"resources:viewOnly\",\"partners:view\",\"adminUserApiKeys:view\",\"partnerDocuments:view\",\"filecatalystLogs:view\"],\"Object\":[\"gon:mft::activeSessions::*\",\"gon:mft::activeTransfers::*\",\"gon:mft::addons::*\",\"gon:mft::addressBooks::*\",\"gon:mft::adminLogs::*\",\"gon:mft::adminServer::*\",\"gon:mft::userGroups::*\",\"gon:mft::userRoles::*\",\"gon:mft::userTemplates::*\",\"gon:mft::users::*\",\"gon:mft::agentTemplates::*\",\"gon:mft::as2Logs::*\",\"gon:mft::as4Logs::*\",\"gon:mft::autoIPBlacklist::*\",\"gon:mft::customTasks::*\",\"gon:mft::databaseConfiguration::*\",\"gon:mft::domains::*\",\"gon:mft::encryptedFolders::*\",\"gon:mft::ftpLogs::*\",\"gon:mft::ftpsLogs::*\",\"gon:mft::gatewayManager::*\",\"gon:mft::godriveLogs::*\",\"gon:mft::gofastLogs::*\",\"gon:mft::holidayCalendars::*\",\"gon:mft::httpsLogs::*\",\"gon:mft::ipFilters::*\",\"gon:mft::jobs::*\",\"gon:mft::keyVaults::*\",\"gon:mft::license::*\",\"gon:mft::logExemptions::*\",\"gon:mft::loginMethods::*\",\"gon:mft::masterEncryptionKeys::*\",\"gon:mft::monitors::*\",\"gon:mft::pesitLogs::*\",\"gon:mft::antivirusLogs::*\",\"gon:mft::queues::*\",\"gon:mft::schedules::*\",\"gon:mft::secureForms::*\",\"gon:mft::secureMail::*\",\"gon:mft::serviceLevelAgreementLogs::*\",\"gon:mft::serviceLevelAgreements::*\",\"gon:mft::services::*\",\"gon:mft::sftpLogs::*\",\"gon:mft::systemLogs::*\",\"gon:mft::triggerLogs::*\",\"gon:mft::triggers::*\",\"gon:mft::webClientBrands::*\",\"gon:mft::webUserDevices::*\",\"gon:mft::webuserGroups::*\",\"gon:mft::webuserTemplates::*\",\"gon:mft::webusers::*\",\"gon:mft::reports::*\",\"gon:mft::projectCategories::*\",\"gon:mft::projects:*:*\",\"gon:mft::resources:*\",\"gon:mft::partners::*\",\"gon:mft::adminUserApiKeys::*\",\"gon:mft::partnerDocuments::*\",\"gon:mft::filecatalystLogs::*\"],\"Domain\":[\"*\"]}]}',0,0),(120,'Partner Manager','Admin users in this role can manage Partners','system','2024-04-22 14:01:11','system','2024-04-22 14:01:11',_binary '{\n  \"Statement\": [\n    {\n      \"Sid\": \"Allowed Permissions Statement\",\n      \"Effect\": \"Allow\",\n      \"Action\": [\n        \"reports:generate\",\n        \"adminLogs:view\",\n        \"partners:*\",\n        \"partnerDocuments:*\"\n      ],\n      \"Object\": [\n        \"gon:mft::partners::*\",\n        \"gon:mft::adminLogs::*\",\n        \"gon:mft::reports::*\",\n        \"gon:mft::partnerDocuments::*\"\n      ],\n      \"Domain\": [\n        \"*\"\n      ]\n    }\n  ]\n}',0,0);
...
CREATE TABLE `dpa_sla_event_log` (
  ...
  KEY `idx_slalog_indexed` (`indexed`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dpa_trigger_log` (
  ...
  KEY `idx_triglog_indexed` (`indexed`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-04-07 18:34:01
